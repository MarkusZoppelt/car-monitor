...
SENSORS = [
   ...
   Sensor("fuel_pressure"         , "$Einspritzdruck"			        , "010A" , cpass            ,""       ),
   Sensor("manifold_pressure"     , "$Intk Manifold"				, "010B" , intake_m_pres    ,"psi"    ),
   Sensor("temp"                  , "Kühlfüssigkeit"		    		, "0105" , temp             ,"C°"      ),
   Sensor("rpm"                   , "Drehzahl Motor"			    	, "010C1", rpm              ,""       ),
   Sensor("speed"                 , "Fahrzeug Speed"				, "010D1", speed            ,"km/h"    ),
   Sensor("timing_advance"        , "Timing Advance"				, "010E" , timing_advance   ,"degrees"),
   Sensor("intake_air_temp"       , "Lufttemp rein"				, "010F" , temp             ,"C°"      ),
   Sensor("maf"                   , "$MAF"		                        , "0110" , maf              ,"lb/min" ),
   Sensor("throttle_pos"          , "Gaspedal"		                	, "01111", throttle_pos     ,"%"      ),
